...
namespace RouterTelnetClient.TelnetClient
{
    ...
    public class VirtualScreen : IDisposable
    {
        ...
        public int Width
        {
            get
            {
                if (this.vs == null) return 0;
                else return this.vs.GetLength(0);
            }
        } // Width
        ...
        public int Height
        {
            ...
            {
                if (this.vs == null) return 0;
                else return this.vs.GetLength(1);
            }
        } // Width
        ...
        private int CursorX0
        {
            ...
            set
            {
                if (value <= 0) this.cursorx0 = 0;
                else if (value >= this.Width) this.cursorx0 = this.Width - 1;
                else this.cursorx0 = value;
            }
        }
        ...
        private int CursorY0
        {
            ...
            set
            {
                if (value <= 0) this.cursory0 = 0;
                else this.cursory0 = value; // due to the scrolling behaviour we do not cut big values
            }
        }
        ...
        private string screenString = null;

        private string screenStringLower = null;
        ...
        {
            if (this.vs == null || xend <= xstart || yend <= ystart || xstart < this.offsetx || xend < this.offsetx
                || ystart < this.offsety || yend < this.offsety) return; // nothing to do
        ...
        public void CleanLine(int xStart, int xEnd)
        {
            ...
            if (this.vs == null || y < 0 || y > this.vs.GetLength(1)) return;
        ...
        public void CleanToCursor()
        {
            ...
            if (y >= this.offsety) this.CleanScreen(this.CursorXLeft, this.offsety, this.CursorXRight, y);
        ...
        {
            int y = this.CursorY + 1; // line before
            if (y <= this.visibleAreaY0bottom + this.offsety) this.CleanScreen(this.CursorXLeft, y, this.CursorXRight, this.visibleAreaY0bottom + this.offsety);
        ...
        public bool WriteByte(byte[] writeBytes)
        {
            ...
            else
            {
                ...
                {
                    if (!this.WriteByte(writeBytes[i], true)) return false;
                }
                return true;
            }
        }
        ...
        public bool WriteByte(byte writeByte, bool moveCursor)
        {
            ...
            else
            {
                switch (writeByte)
                {
                    ...
                    default:
                        int y = this.CursorY0;
                        if (this.visibleAreaY0top > 0) y -= this.visibleAreaY0top;
                        if (y >= 0)
                        {
                            try
                            {
                                this.vs[this.CursorX0, y] = writeByte;
                            }
                            catch
                            {
        ...
        {
            if (s == null) return false;
            else return this.WriteByte(Encoding.ASCII.GetBytes(s));
        }
        ...
        public string GetLine(int yPosition)
        {
            ...
            if (this.vs == null || y0 >= this.Height || this.Width < 1) return null;
            else
            {
        ...
        public string Hardcopy(bool lowercase)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (lowercase)
                    {
                        if (this.screenStringLower == null) this.screenStringLower = this.screenString.ToLower();
                        return this.screenStringLower;
                    }
                    else return this.screenString; // from cache
                }
            }
        } // method Hardcopy
        ...
        {
            if (this.vs == null || findString == null || findString.Length < 1) return null;
            try
            {
                ...
                {
                    if (caseSensitive) return findString;
                    else
                    {
        ...
        {
            if (this.vs == null || regExp == null || regExp.Length < 1) return null;
        ...
        {
            if (this.vs == null || regExp == null) return null;
